...
public abstract class NanoHTTPD {
    ...
    public static class DefaultTempFileManager implements TempFileManager {
        ...
        public DefaultTempFileManager() {
            ...
            // I replace above code with below code in order to speed up the copying of uploaded file.
            tmpdir = Environment.getExternalStorageDirectory().getAbsolutePath() + "/id.ZulNs/WiFiRemote/temp/";
        ...
        public void parseBody(Map<String, String> files) throws IOException, ResponseException {
            ...
            try {
                ...
                while (rlen >= 0 && size > 0) {
                    ...
                    rlen = inputStream.read(buf, 0, (int)Math.min(size, 65536));
                    size -= rlen;
                    if (rlen > 0) {
